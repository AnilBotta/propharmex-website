 ...
 * namespaced telemetry helpers in
 * `apps/web/components/{concierge,scoping,del-readiness,dosage-matcher,site}/telemetry.ts`.
 */
...
export { readCookieFromHeader, readRegionFromCookie } from "./region-cookie";
