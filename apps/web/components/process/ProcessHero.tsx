/**
 * ProcessHero — /our-process hero, RSC.
 *
 * LCP-safe hero: eyebrow, headline, lede, 3-stat dl, paired CTAs. Same
 * shape as the case-studies and insights heroes for visual consistency.
 */
...
import type { ProcessHero as ProcessHeroContent } from "../../content/process";

type Props = { content: ProcessHeroContent };

export const ProcessHero: FC<Props> = ({ content }) => {
  return (
    <section
      aria-labelledby="proc-hero-heading"
