/**
 * HubClosing — /insights hub final CTA card, RSC.
 */
...
type Props = { content: InsightsHubContent["closing"] };

export const HubClosing: FC<Props> = ({ content }) => {
  return (
    <section
      id="hub-closing"
      aria-labelledby="ins-hub-closing-heading"
