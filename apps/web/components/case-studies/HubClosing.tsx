/**
 * HubClosing — /case-studies hub final CTA card, RSC.
 */
...
import type { CaseStudyHubClosing as HubClosingContent } from "../../content/case-studies";
...
export const HubClosing: FC<Props> = ({ content }) => {
  return (
    <section
      id="hub-closing"
      aria-labelledby="cs-hub-closing-heading"
