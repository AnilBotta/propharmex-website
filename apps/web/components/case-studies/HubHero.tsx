/**
 * HubHero — /case-studies hub hero, RSC.
 *
...
import type { CaseStudyHubHero as HubHeroContent } from "../../content/case-studies";
...
export const HubHero: FC<Props> = ({ content }) => {
  return (
    <section
      aria-labelledby="cs-hub-hero-heading"
