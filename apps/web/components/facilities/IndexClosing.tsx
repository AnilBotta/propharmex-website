/**
 * IndexClosing — /facilities, RSC.
 *
 * Closing CTA block for the index page. Mirrors the site's standard closing
 * pattern — eyebrow / heading / body / primary + secondary CTAs.
 */
...
import type { FacilitiesContent } from "../../content/facilities";

import { SectionReveal } from "./SectionReveal";

type Props = { content: FacilitiesContent["closing"] };

export const IndexClosing: FC<Props> = ({ content }) => {
  return (
    <section
      id="next"
      aria-labelledby="facilities-closing-heading"
