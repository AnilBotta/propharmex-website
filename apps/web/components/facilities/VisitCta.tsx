/**
 * VisitCta — /facilities/[site] detail, RSC.
 *
 * Closing CTA with site-specific visit logistics. The notice line captures the
 * NDA / photography / PPE conventions applicable to both sites; CTAs route to
 * /contact with a source tag.
 */
...
export const VisitCta: FC<Props> = ({ content }) => {
  return (
    <section
      id="visit"
      aria-labelledby="facility-visit-heading"
