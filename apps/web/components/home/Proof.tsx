              ...
              >
                ...
                <div className="mt-auto flex items-end justify-between gap-4 border-t border-[var(--color-border)] pt-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="font-[family-name:var(--font-mono)] text-xl font-semibold tabular-nums text-[var(--color-primary-700)]">
                      {card.metric}
                    </span>
                  </div>
                  <span
                    aria-hidden="true"
                    className="inline-flex items-center gap-1 text-sm font-medium text-[var(--color-primary-700)]"
                  >
                    Read
                    <ArrowUpRight
                      size={14}
