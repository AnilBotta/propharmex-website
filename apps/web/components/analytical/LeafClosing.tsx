/**
 * LeafClosing — analytical leaf final CTA block, RSC.
 *
 * Closing card plus a primary-source regulatory reference for the sub-service
 * (e.g., ICH Q14 for method development).
 */
...
import type { AnalyticalClosingCta } from "../../content/analytical-services";

import { SectionReveal } from "./SectionReveal";

type Props = { content: AnalyticalClosingCta };
...
export const LeafClosing: FC<Props> = ({ content }) => {
  ...
  return (
    <section
      id="leaf-closing"
      aria-labelledby="as-leaf-closing-heading"
