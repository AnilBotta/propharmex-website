/**
 * ChallengesList — analytical leaf "typical challenges" block, RSC.
 */
import type { FC } from "react";
import { AlertCircle } from "lucide-react";

import type { AnalyticalChallenges } from "../../content/analytical-services";

import { SectionReveal } from "./SectionReveal";

type Props = { content: AnalyticalChallenges };

export const ChallengesList: FC<Props> = ({ content }) => {
  return (
    <section
      id="challenges"
      aria-labelledby="as-leaf-challenges-heading"
