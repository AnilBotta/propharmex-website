...
/**
 * FaqAccordion — analytical leaf FAQ, client island.
 *
...
import type { AnalyticalFaq } from "../../content/analytical-services";

type Props = { content: AnalyticalFaq };

export const FaqAccordion: FC<Props> = ({ content }) => {
  return (
    <section
      id="faq"
      aria-labelledby="as-leaf-faq-heading"
