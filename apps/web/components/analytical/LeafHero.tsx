/**
 * LeafHero — /services/analytical-services/[service], RSC.
 *
...
import type { AnalyticalLeafHero as LeafHeroContent } from "../../content/analytical-services";
...
export const LeafHero: FC<Props> = ({ content }) => {
  return (
    <section
      aria-labelledby="as-leaf-hero-heading"
