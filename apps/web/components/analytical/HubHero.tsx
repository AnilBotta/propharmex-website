/**
 * HubHero — /services/analytical-services, RSC.
 *
 * LCP-safe hero with eyebrow, headline, lede, 3-stat dl and two CTAs.
 */
...
import type { AnalyticalHubHero as HubHeroContent } from "../../content/analytical-services";

type Props = { content: HubHeroContent };

export const HubHero: FC<Props> = ({ content }) => {
  return (
    <section
      aria-labelledby="as-hub-hero-heading"
