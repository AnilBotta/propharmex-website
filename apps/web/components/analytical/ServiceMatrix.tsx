/**
 * ServiceMatrix — analytical-services hub 7-service capability grid, RSC.
 *
 * Live cards wrap in a Link; shipping-next cards render as a muted disabled
 * affordance so no stale internal links exist.
 */
...
import type {
  AnalyticalServiceMatrix as ServiceMatrixContent,
...
export const ServiceMatrix: FC<Props> = ({ content }) => {
  return (
    <section
      id="services"
      aria-labelledby="as-hub-matrix-heading"
...
function ServiceCard({
  ...
  service: AnalyticalServiceSummary;
  liveCopy: string;
