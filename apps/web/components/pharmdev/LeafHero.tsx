/**
 * LeafHero — /services/pharmaceutical-development/[dosageForm], RSC.
 *
 * Hero with a distinct value-prop slot in addition to the lede. LCP-safe.
 */
...
import type { DosageFormHero } from "../../content/pharmaceutical-development";

type Props = { content: DosageFormHero };

export const LeafHero: FC<Props> = ({ content }) => {
  return (
    <section
      aria-labelledby="pd-leaf-hero-heading"
