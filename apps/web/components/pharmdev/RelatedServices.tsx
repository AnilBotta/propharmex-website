/**
 * RelatedServices — leaf cross-links block, RSC.
 *
 * Three adjacent services with short descriptions. Each card is a full-bleed
...
export const RelatedServices: FC<Props> = ({ content }) => {
  return (
    <section
      id="related"
      aria-labelledby="pd-leaf-related-heading"
