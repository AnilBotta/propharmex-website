/**
 * SelfCheckBlock — leaf "is this right for you?" self-check, RSC.
 *
 * Three scannable questions + helper text, paired with a CTA that routes to
 * /ai/dosage-matcher with a `source` param so the Matcher (Prompt 18) can
 * attribute inbound and later pre-seed its first turn.
 */
...
export const SelfCheckBlock: FC<Props> = ({ content }) => {
  return (
    <section
      id="self-check"
      aria-labelledby="pd-leaf-selfcheck-heading"
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <SectionReveal className="mt-12">
          <ol className="flex flex-col gap-4" aria-label="Self-check questions">
