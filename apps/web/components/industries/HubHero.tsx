...
import type { IndustryHubHero as HubHeroContent } from "../../content/industries";
...
export const HubHero: FC<Props> = ({ content }) => {
  return (
    <section
      aria-labelledby="ind-hub-hero-heading"
