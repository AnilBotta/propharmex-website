/**
 * CaseStudyRail — industry leaf worked-patterns rail, RSC.
 *
 * Three anonymized teasers, each with a "Documentation on request" pill.
 * Named, permission-cleared case studies land with Prompt 14.
 */
...
import type { IndustryCaseRail as CaseRailContent } from "../../content/industries";
...
export const CaseStudyRail: FC<Props> = ({ content }) => {
  return (
    <section
      id="case-rail"
      aria-labelledby="ind-leaf-caserail-heading"
