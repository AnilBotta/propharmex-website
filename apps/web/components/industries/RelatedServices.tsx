/**
 * RelatedServices — industry leaf cross-links block, RSC.
 */
import type { FC } from "react";
import Link from "next/link";
import { ArrowUpRight } from "lucide-react";

import type { IndustryRelated } from "../../content/industries";

import { SectionReveal } from "./SectionReveal";

type Props = { content: IndustryRelated };

export const RelatedServices: FC<Props> = ({ content }) => {
  return (
    <section
      id="related"
      aria-labelledby="ind-leaf-related-heading"
