/**
 * HubClosing — /industries final CTA card, RSC.
 */
...
import type { IndustryHubClosing as HubClosingContent } from "../../content/industries";
...
export const HubClosing: FC<Props> = ({ content }) => {
  return (
    <section
      id="hub-closing"
      aria-labelledby="ind-hub-closing-heading"
