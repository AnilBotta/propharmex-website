/**
 * HubHero — /services/regulatory-services, RSC.
 *
 * LCP-safe hero: eyebrow, headline, lede, 3-stat dl, paired CTAs.
 */
...
import type { RegulatoryHubHero as HubHeroContent } from "../../content/regulatory-services";
...
export const HubHero: FC<Props> = ({ content }) => {
  return (
    <section
      aria-labelledby="rs-hub-hero-heading"
