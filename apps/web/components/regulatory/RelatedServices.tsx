/**
 * RelatedServices — regulatory leaf cross-links block, RSC.
 */
import type { FC } from "react";
import Link from "next/link";
import { ArrowUpRight } from "lucide-react";

import type { RegulatoryRelated } from "../../content/regulatory-services";

import { SectionReveal } from "./SectionReveal";

type Props = { content: RegulatoryRelated };

export const RelatedServices: FC<Props> = ({ content }) => {
  return (
    <section
      id="related"
      aria-labelledby="rs-leaf-related-heading"
