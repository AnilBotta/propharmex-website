/**
 * LeafHero — /services/regulatory-services/[service], RSC.
 *
...
import type { RegulatoryLeafHero as LeafHeroContent } from "../../content/regulatory-services";
...
export const LeafHero: FC<Props> = ({ content }) => {
  return (
    <section
      aria-labelledby="rs-leaf-hero-heading"
