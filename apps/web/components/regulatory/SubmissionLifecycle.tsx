 ...
 *
 * strategy → dossier → submission → inspection → lifecycle, with ownership
 * chips (hyderabad / mississauga / both) that mirror the analytical hub
 * lifecycle visually.
 */
...
import type {
  SubmissionLifecycle as LifecycleContent,
...
const OWNER_META: Record<
  SubmissionLifecycleStage["owner"],
