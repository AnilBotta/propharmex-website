/**
 * HubClosing — /services/regulatory-services final CTA card, RSC.
 */
...
import type { RegulatoryHubClosing as HubClosingContent } from "../../content/regulatory-services";
...
export const HubClosing: FC<Props> = ({ content }) => {
  return (
    <section
      id="hub-closing"
      aria-labelledby="rs-hub-closing-heading"
