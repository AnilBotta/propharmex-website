/**
 * CaseStudyRail — regulatory-services hub worked-patterns rail, RSC.
 *
...
import type { RegulatoryCaseRail as CaseRailContent } from "../../content/regulatory-services";
...
export const CaseStudyRail: FC<Props> = ({ content }) => {
  return (
    <section
      id="case-rail"
      aria-labelledby="rs-hub-caserail-heading"
