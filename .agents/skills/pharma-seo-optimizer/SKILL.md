...
description: SEO + GEO (AI-citation) optimization tuned for pharma/biotech/CDMO vertical. Provides keyword research, on-page audit, competitor gap analysis, content refresh, and AI-citability scoring. Optimizes for both Google SERP and AI answer engines (ChatGPT, Codex, Perplexity, Gemini).
