...
when_to_use: User asks for a whitepaper, lead magnet, long-form PDF, executive guide, playbook, or regulatory explainer deliverable. Also invoked by Prompt 15 (whitepapers pipeline) and Prompt 6 (the Canadian CDMO operating-model playbook).
---
